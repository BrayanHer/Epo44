...
* {
	...
	padding:1px;
		...
		<form action="{{route('GMaestros')}}" method="POST" enctype='multipart/form-data'>                        
		  {{csrf_field()}}
			<div class="container">
	<div class="row">
				<div class="alert alert-primary col-md-12" role="alert" aling="centers">
					<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#AMaestro">
						<i class="fa fa-fw fa-plus"></i>
					</button> &nbsp; Agregar nuevo "Maestro"
				</div>
				<!-- Modal -->
		    <div class="modal fade" id="AMaestro" tabindex="-1" role="dialog" aria-labelledby="AMaestroLabel" aria-hidden="true">
