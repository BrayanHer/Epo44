...
class Alumnos extends Migration
{
    public function up()
    {
        Schema::create('alumnos',function(Blueprint $table)
        {
          ...
          $table->integer('IdFormAcademica')->unsigned();
          $table->foreign('IdFormAcademica')->references('IdFormAcademica')->on('formaciones');

          $table->integer('IdStatus')->unsigned();
          $table->foreign('IdStatus')->references('IdStatus')->on('statusEstudiantes');
